        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-500 max-w-2xl">
                    Atur koleksi buku perpustakaan dengan mudah dan efisien.
                </p>
            </div>
            <a href="{{ route('books.create') }}" class="inline-flex items-center justify-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-2xl shadow-sm transition">
                Tambah Buku
            </a>
        </div>
    </x-slot>
