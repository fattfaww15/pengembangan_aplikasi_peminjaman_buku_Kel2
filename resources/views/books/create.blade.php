    ...
    <x-slot name="header">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-500 max-w-2xl">
                Masukkan informasi lengkap buku untuk menambahkannya ke koleksi.
            </p>
        </div>
    </x-slot>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('books.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="stock" id="stock" value="{{ old('stock') }}" min="0" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                            @error('stock')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="published_year" id="published_year" value="{{ old('published_year') }}" min="1000" max="{{ date('Y') + 1 }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
